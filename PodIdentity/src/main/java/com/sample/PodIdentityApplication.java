...
public class PodIdentityApplication {

    private static final Logger LOGGER = LoggerFactory.getLogger(PodIdentityApplication.class);


    public static void main(String[] args) {
        SpringApplication.run(PodIdentityApplication.class, args);
    }
